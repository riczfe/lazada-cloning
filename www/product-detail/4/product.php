		...
		<div class="root">
            ...
            <div class="container">
                ...
                <div class="product-image">
                    <div class="main-img">
                        <img src="https://lzd-img-global.slatic.net/g/p/53fa9f1b56601a46a8454fd411ccfac3.jpg_720x720q80.jpg_.webp" alt="productimage">
                    </div>
                    <div class="slider">
                        <div class="slide-img">
                ...
                <div class="detail-container">
                    <form name=ShoppingList>
                        <div class="title">
                            ...
                            <br>
                            <a name="name" id="name">Điện Thoại Xiaomi Redmi 9A - RAM 2GB Bộ Nhớ Trong 32GB...</a>
                        </div>
                        <div class="brand">
                            <span>Brand: <a href="xiaomi.com">Xiaomi</a> | <a href="xiaomi.com">More Smartphones from Xiaomi</a></span>
                        </div>
                        <div class="price-tag">
                            ₫ <span class="price" id="data">3,390,000</span>
                        </div>
                    </form>    
                    <!-- ADD TO CART -->
                    <div class="cart">
