		...
		<div class="root">
            ...
            <div class="container">
                ...
                <div class="product-image">
                    <div class="main-img">
                        <img src="https://lzd-img-global.slatic.net/g/p/d42a7396a24e0baaa0dd0dba72af9a46.png_720x720q80.jpg_.webp" alt="productimage">
                    </div>
                    <div class="slider">
                        <div class="slide-img">
                ...
                <div class="detail-container">
                    <form name=ShoppingList>
                        <div class="title">
                            ...
                            <br>
                            <a name="name" id="name">Apple iPhone 12 - Hàng Chính Hãng</a>
                        </div>
                        <div class="brand">
                            <span>Brand: <a href="apple.com">Apple</a> | <a href="apple.com">More Smartphones from Apple</a></span>
                        </div>
                        <div class="price-tag">
                            ₫ <span class="price" id="data">15,290,000</span>
                        </div>
                    </form>    
                    <!-- ADD TO CART -->
                    <div class="cart">
