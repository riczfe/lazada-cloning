		...
		<div class="root">
            ...
            <div class="container">
                ...
                <div class="product-image">
                    <div class="main-img">
                        <img src="https://lzd-img-global.slatic.net/g/p/cb2b3bdab5b0f24c06b77b53f49fdcac.png_720x720q80.jpg_.webp" alt="productimage">
                    </div>
                    <div class="slider">
                        <div class="slide-img">
                ...
                <div class="detail-container">
                    <form name=ShoppingList>
                        <div class="title">
                            ...
                            <br>
                            <a name="name" id="name">Điện thoại OPPO A95 8GB/128GB - Hàng chính hãng</a>
                        </div>
                        <div class="brand">
                            <span>Brand: <a href="oppo.com">Oppo</a> | <a href="oppo.com">More Smartphones from Oppo</a></span>
                        </div>
                        <div class="price-tag">
                            ₫ <span class="price" id="data">6,390,000</span>
                        </div>
                    </form>    
                    <!-- ADD TO CART -->
                    <div class="cart">
