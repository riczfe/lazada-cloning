		...
		<div class="root">
            ...
            <div class="container">
                ...
                <div class="product-image">
                    <div class="main-img">
                        <img src="https://lzd-img-global.slatic.net/g/p/1c8ea7088b31d9a16874091128c9e967.jpg_720x720q80.jpg_.webp" alt="productimage">
                    </div>
                    <div class="slider">
                        <div class="slide-img">
                ...
                <div class="detail-container">
                    <form name=ShoppingList>
                        <div class="title">
                            ...
                            <br>
                            <a name="name" id="name">Điện thoại Samsung Galaxy A32 (6GB/128GB)- Hàng chính hãng mới 100% Nguyên Seal</a>
                        </div>
                        <div class="brand">
                            <span>Brand: <a href="samsung.com">Samsung</a> | <a href="samsung.com">More Smartphones from Samsung</a></span>
                        </div>
                        <div class="price-tag">
                            ₫ <span class="price" id="data">4,875,000</span>
                        </div>
                    </form>    
                    <!-- ADD TO CART -->
                    <div class="cart">
