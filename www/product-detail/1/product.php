		...
		<div class="root">
            ...
            <div class="container">
                ...
                <div class="product-image">
                    <div class="main-img">
                        <img src="https://lzd-img-global.slatic.net/g/p/b03608ee3dcd8d123eabf664b34e33e2.png_720x720q80.jpg_.webp" alt="productimage">
                    </div>
                    <div class="slider">
                        <div class="slide-img">
                ...
                <div class="detail-container">
                    <form name=ShoppingList>
                        <div class="title">
                            ...
                            <br>
                            <a name="name" id="name">Apple iPhone 11 - Hàng Chính Hãng</a>
                        </div>
                        <br>
                        <div class="brand">
                        ...
                        <div class="price-tag">
                            ₫ <span class="price" id="data">10,990,000</span>
                        </div>
                    </form>    
                    <!-- ADD TO CART -->
                    <div class="cart">
