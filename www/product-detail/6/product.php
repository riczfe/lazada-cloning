		...
		<div class="root">
            ...
            <div class="container">
                ...
                <div class="product-image">
                    <div class="main-img">
                        <img src="https://lzd-img-global.slatic.net/g/p/ea4fb6bebf9f9eb54faf8e1acfc7231d.jpg_720x720q80.jpg_.webp" alt="productimage">
                    </div>
                    <div class="slider">
                        <div class="slide-img">
                ...
                <div class="detail-container">
                    <form name=ShoppingList>
                        <div class="title">
                            ...
                            <br>
                            <a name="name" id="name">[Trả góp 0%] Điện Thoại Samsung Galaxy A23 (4GB/128GB) - Hàng Chính Hãng, Mới 100%, Nguyên Seal | Bảo hành 12 tháng</a>
                        </div>
                        <div class="brand">
                            <span>Brand: <a href="samsung.com">Samsung</a> | <a href="samsung.com">More Smartphones from Samsung</a></span>
                        </div>
                        <div class="price-tag">
                            ₫ <span class="price" id="data">4,656,000</span>
                        </div>
                    </form>    
                    <!-- ADD TO CART -->
                    <div class="cart">
