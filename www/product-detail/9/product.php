		...
		<div class="root">
            ...
            <div class="container">
                ...
                <div class="product-image">
                    <div class="main-img">
                        <img src="https://lzd-img-global.slatic.net/g/p/6dde91e0ff430da0c231ae8ef310afb3.jpg_720x720q80.jpg_.webp" alt="productimage">
                    </div>
                    <div class="slider">
                        <div class="slide-img">
                ...
                <div class="detail-container">
                    <form name=ShoppingList>
                        <div class="title">
                            ...
                            <br>
                            <a name="name" id="name">Điện thoại OPPO A16k 3GB/32GB - Hàng chính hãng</a>
                        </div>
                        <div class="brand">
                            <span>Brand: <a href="apple.com">Apple</a> | <a href="apple.com">More Smartphones from Apple</a></span>
                        </div>
                        <div class="price-tag">
                            ₫ <span class="price" id="data">2,890,000</span>
                        </div>
                    </form>    
                    <!-- ADD TO CART -->
                    <div class="cart">
