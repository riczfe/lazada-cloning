    ...
    <div class = "container">
        <div class = "forms">
            ...
            <div class = "form register">
                ...
                <form  method="POST" action="register-ss.php">
                    <div class = "input-field">
                        <input name="username" type="text" placeholder="Username" pattern="[a-zA-Z]{8,15}" class="form-control" 
                            title="Only letter and length 8-15 characters" required>
                        <i class = "uil uil-user"></i>
                    </div>
                    <div class = "input-field">
                        <input type="text" placeholder="Type 'vendor' to confirm" name="type" pattern="vendor" required>
                        <i class = "uil uil-user"></i>
                    </div>
                    <div class = "input-field">
                        <input type="text" placeholder="Business name" name="name" pattern=".{5,}" required>
                        <i class = "uil uil-user"></i>
                    </div>
                    <div class = "input-field">
                        <input type="text" placeholder="Business address" name="address" pattern=".{5,}" required>
